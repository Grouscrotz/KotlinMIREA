...
class MainActivity : ComponentActivity() {
    ...
    // Функция для запуска задачи на удаление изображений
...
// Worker для удаления изображений
...
fun MainScreen(
    ...
    onDeleteImagesClick: () -> Unit // Параметр для кнопки удаления изображений
) {
        ...
        drawerContent = {
            ModalDrawerSheet {
                Column {
                    ...
                    // Drawer Item for Download Image Screen
                    TextButton(onClick = {
                    ...
                    // Drawer Item for Image List Screen
                    TextButton(onClick = {
...
fun DownloadImageScreen(
    ...
    paddingValues: PaddingValues,
    context: Context,
    onDeleteImagesClick: () -> Unit // Получаем параметр для удаления изображений
) {
    Column(
        modifier = Modifier
            .fillMaxSize()
